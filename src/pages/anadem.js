  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl pb-24 p-8 lg:p-0 lg:pb-24">
        ...
        <div className="bg-yellow-500 rounded-lg shadow text-center mt-24 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="max-w-screen-lg  sm:text-lg text-gray-400">
            ...
            <h2 className="mb-4 lg:text-5xl text-xl tracking-tight font-bold  text-white">
              Faça sua adesão agora mesmo!
            </h2>

            <Link
              href="/anadem"
              className="inline-flex bg-gray-300 items-center font-medium rounded-lg px-3 py-2 text-white hover:text-gray-800 text-primary-500 hover:text-primary-700"
            >
              Fazer adesão
              <svg
