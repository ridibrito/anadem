...
export default function Fumdap() {
  return (
    <>
      <section className="bg-green-900 w-screen mx-auto text-center ">
        <div className=" w-screen py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <Link
              href="/anadem"
              className="inline-flex items-center font-medium text-primary-600 hover:text-primary-800 text-gray-300 border rounded px-3 py-2 hover:text-primary-700"
            >
              Saiba mais
              <svg
